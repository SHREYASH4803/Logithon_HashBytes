...
def create_data_model():
    ...
    data['demands'] = d
    data['time_per_demand_unit'] = 0.16666667
    data['num_vehicles'] = 20
    data['vehicle_capacity'] = 80
    data['vehicle_speed'] = 1666.67
    data['depot'] = 0
    return data
    ...
    for from_node in xrange(data['num_locations']):
        ...
        for to_node in xrange(data['num_locations']):
            if from_node == to_node:
                ...
                _distances[from_node][to_node] = (euclidean_distance(data['locations'][from_node], data['locations'][to_node]))
